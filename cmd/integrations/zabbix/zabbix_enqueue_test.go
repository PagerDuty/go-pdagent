...
func TestZabbixEnqueue_validInputs(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			expectedResponseBody: map[string]interface{}{
				"routing_key":  "zabbix_integration_key",
				"event_action": "trigger",
				"dedup_key":    "{TRIGGER.ID}-{HOST.NAME}",
				"payload": map[string]interface{}{
					"summary":  "{TRIGGER.NAME} : {TRIGGER.STATUS} for {HOST.NAME}",
					"severity": "error",
					"source":   "SET_BY_PAGERDUTY",
		...
		},
		{
			...
			expectedResponseBody: map[string]interface{}{
				...
				"dedup_key":    "provided_incident_key",
				"payload": map[string]interface{}{
					"summary":  "{TRIGGER.NAME} : {TRIGGER.STATUS} for {HOST.NAME}",
					"severity": "error",
					"source":   "SET_BY_PAGERDUTY",
